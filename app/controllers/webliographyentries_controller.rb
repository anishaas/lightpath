class WebliographyentriesController < ActionController::Base
  ...
  def post_to_api
    ...
    #seed new Lightbulb
    @lightbulb = Lightbulb.create(course_id: @course.id, lesson_id: params["lightbulb"][:lesson_id].to_i ,student_id: Student.find(1).id, summary: params["lightbulb"][:summary],
